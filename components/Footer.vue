    ...
    <div class="mx-auto px-6 pt-16 pb-8 sm:pt-24 lg:px-[70px] lg:pt-16">
      <div class="xl:grid xl:grid-cols-3 xl:gap-8">
        <div class="space-y-8">
          ...
          <p class="text-sm/6 text-balance text-gray-600">Your innovation deserves a smooth path to market.<br/> We manage regulatory and market entry challenges<br/> for medical devices worldwide.</p>
      ...
      <div class="mt-16 border-t border-gray-900/10 pt-8 sm:mt-20 md:flex md:items-center md:justify-between lg:mt-24">
        ...
        <p class="text-sm/6 text-gray-600">Copyright &copy; 2025 All Rights Reserved by 4betterdevices.</p>
      </div>
    </div>
  </footer>
</template>
