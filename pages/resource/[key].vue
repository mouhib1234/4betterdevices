<template>
  <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
    <NuxtLink
      to="/"
      class="inline-flex items-center text-[#0fb2b1] hover:underline text-sm font-medium"
    >
      ← Back to Resources
    </NuxtLink>
...
// If this resource has an external link, send the user straight there:
onMounted(() => {
  if (resource?.value?.link) {
    // Use replace so hitting “back” doesn’t show this empty-detail page
